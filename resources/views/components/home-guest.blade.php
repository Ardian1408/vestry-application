<div class=" grid grid-cols-9 gap-4 bg-white mt-20 rounded-md p-4 md:w-[42rem] sm:w-[32rem] w-[20rem] shadow-md shadow-black/50">
  <div class="md:col-span-3 sm:col-span-6 col-span-full flex flex-col gap-y-2 items-center justify-start h-full text-center">
    <img src="images\icons8-list-is-empty.gif" class="w-10 h-10 object-contain object-center" alt="">
    <h3 class="text-amber-400 font-medium">Deskripsi Usaha</h3>
    <p class="text-neutral-400 text-sm font-light">Fitur yang dapat membantu mitra memperkenalkan usahanya sehingga membantu pendana untuk memberikan modal</p>
  </div>
  <div class="md:col-span-3 sm:col-span-6 col-span-full flex flex-col gap-y-2 items-center justify-start h-full text-center">
    <img src="images\icons8-create.gif" class="w-10 h-10 object-contain object-center" alt="">
  ...
  <div class="md:col-span-3 sm:col-span-6 col-span-full flex flex-col gap-y-2 items-center justify-start h-full text-center">
    <img src="images\icons8-time-machine.gif" class="w-10 h-10 object-contain object-center" alt="">
